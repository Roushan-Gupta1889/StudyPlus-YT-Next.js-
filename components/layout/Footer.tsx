        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-semibold text-foreground">StudyPlus YT</span>
            </Link>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Learn from YouTube without the distractions. Focus on what matters.
            </p>
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${social.colorClass}`}
                >
