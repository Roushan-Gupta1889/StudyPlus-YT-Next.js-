    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8 sm:py-0">
            <div className="w-full max-w-md">
                ...
                {/* Login Card */}
                <div className="card">
                    <h1 className="text-xl sm:text-2xl font-bold text-text-primary mb-1 sm:mb-2">Welcome back</h1>
                    <p className="text-sm sm:text-base text-text-secondary mb-4 sm:mb-6">Sign in to continue your learning journey</p>
